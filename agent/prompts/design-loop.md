...
1. Shape the goal in the parent session. Use `/grill-with-docs` and `/domain-modeling` if the repo has those skills available. For architectural deepening, use module/interface/depth/seam/adapter/leverage/locality language.
