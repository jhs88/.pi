...
1. **explore** → handoff file (findings)
2. Human reviews handoff, appends notes on what matters most
3. **explore** → reads updated handoff, identifies deepening opportunities, writes candidates to new handoff
...
**After Step 1 (explore):** Summarize top findings. Ask: what matters most? Any constraints or areas to skip? Append your notes to the handoff file, then continue chain.

**After Step 2 (explore candidates):** Present numbered candidates with Files/Problem/Solution/Benefits. Ask: which candidate should we implement? Append your choice to the handoff file, then continue chain.
