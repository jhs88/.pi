...
// Dracula palette: purple → pink → cyan
const PURPLE: Rgb = [189, 147, 249];
const PINK: Rgb = [255, 121, 198];
const CYAN: Rgb = [139, 233, 253];
const PALETTE: Rgb[] = [PURPLE, PINK, CYAN, PINK, PURPLE];
...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerCommand("flow-title", {
    description: "Enable the Dracula flowing gradient session header",
